...
namespace MachineClassLibrary.Laser
{
    ...
    public  class Lmc
    {
        ...
        public static int HatchObject(string objectName, HatchParams hatchParams) => lmc1_SetHatchEntParam(
                                               objectName,
                                               hatchParams.EnableContour,
                                               hatchParams.ParamIndex,
                                               hatchParams.EnableHatch,
                                               hatchParams.PenNo,
                                               hatchParams.HatchType,
                                               hatchParams.HatchAllCalc,
                                               hatchParams.HatchEdge,
                                               hatchParams.HatchAverageLine,
                                               hatchParams.HatchLineDist,
                                               hatchParams.HatchEdgeDist,
                                               hatchParams.HatchStartOffset,
                                               hatchParams.HatchEndOffset,
                                               hatchParams.HatchLineReduction,
                                               hatchParams.HatchLoopDist,
                                               hatchParams.EdgeLoop,
                                               hatchParams.HatchLoopRev,
                                               hatchParams.HatchAutoRotate,
                                               hatchParams.HatchRotateAngle);


        public static int SetHatchParams(HatchParams hatchParams) => lmc1_SetHatchParam(hatchParams.EnableContour,
            hatchParams.EnableHatch,
            hatchParams.PenNo,
            HATCHATTRIB_LOOP,//40
            hatchParams.HatchEdgeDist,

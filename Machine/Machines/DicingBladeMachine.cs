...
public class DicingBladeMachine : PCI124XXMachine, IHasCamera, IHasSCF, IHasValves, IHasSensors, IDisposable, IHasPlaces<Place>
{
    ...
    protected override void OnVelocityRegimeChanged(Velocity velocity) => OnVelocityBeenChanged?.Invoke(this, velocity);
...
{
    private readonly IHasMotion _hasMotion;
    ...
    public async Task MoveAxInPosAsync(Ax axis, double position, bool precisely = false, CancellationToken cancellationToken = default)
    {
        var vel = _hasMotion.VelocityRegime;
        _hasMotion.SetVelocity(_velocity);
        try
        {
            await _hasMotion.MoveAxInPosAsync(axis, position, precisely, cancellationToken).ConfigureAwait(false);
        }
        catch (Exception)
        {
    ...
    public async Task MoveAxRelativeAsync(Ax axis, double diffPosition, bool precisely = false)
    {
        ...
        try
        {
            await _hasMotion.MoveAxRelativeAsync(axis, diffPosition, precisely).ConfigureAwait(false);
        }
        catch (Exception)
        {
    ...
    public async Task MoveAxesInPlaceAsync(Place place)
    {
        ...
        try
        {
            await _hasPlaces.MoveAxesInPlaceAsync(place).ConfigureAwait(false);
        }
        catch (Exception)
        {
    ...
    public bool IsMotionDeviceInit { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    public Velocity VelocityRegime { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

    public event EventHandler<AxisStateEventArgs> OnAxisMotionStateChanged;

    public IAxisBuilder AddAxis(Ax ax, double lineCoefficient) => throw new NotImplementedException();

    public IHasMotion AddGroup(Groups group, Ax[] axes) => throw new NotImplementedException();

    public void ConfigureAxesGroups(Dictionary<Groups, Ax[]> groups) => throw new NotImplementedException();

    public void ConfigureDoubleFeatures(Dictionary<MFeatures, double> doubleFeatures) => throw new NotImplementedException();

    public IHomingBuilder ConfigureHomingForAxis(Ax axis) => throw new NotImplementedException();

    public void EmergencyStop() => throw new NotImplementedException();

    public void EmgScenario() => throw new NotImplementedException();

    public void EmgStop() => throw new NotImplementedException();

    public double GetAxActual(Ax axis) => throw new NotImplementedException();

    public double GetAxCmd(Ax axis) => throw new NotImplementedException();

    public double GetAxisSetVelocity(Ax axis) => throw new NotImplementedException();

    public double GetFeature(MFeatures feature) => throw new NotImplementedException();

    public async Task GoHomeAsync() => throw new NotImplementedException();

    public void GoWhile(Ax axis, AxDir direction) => throw new NotImplementedException();

    public void MotionDevInitialized() => throw new NotImplementedException();

    public Task MoveGpInPosAsync(Groups group, double[] position, bool precisely = false) => throw new NotImplementedException();

    public Task MoveGpRelativeAsync(Groups group, double[] offset, bool precisely = false) => throw new NotImplementedException();

    public void ResetErrors(Ax axis) => throw new NotImplementedException();

    public void SetAxFeedSpeed(Ax axis, double feed) => throw new NotImplementedException();

    public void SetAxisPosition(Ax axis, double position) => throw new NotImplementedException();

    public void SetGroupConfig(int gpNum, MotionDeviceConfigs configs) => throw new NotImplementedException();
    ...
    public void Stop(Ax axis) => throw new NotImplementedException();

    public Task WaitUntilAxisStopAsync(Ax axis) => throw new NotImplementedException();

    public double GetGeometry(Place place, int arrNum) => throw new NotImplementedException();

    public double GetGeometry(Place place, Ax axis) => throw new NotImplementedException();
    public Task MoveGpInPlaceAsync(Groups group, Place place, bool precisely = false) => throw new NotImplementedException();
    public (Ax, double)[] TranslateActualCoors(Place place) => throw new NotImplementedException();
    public double TranslateActualCoors(Place place, Ax axis) => throw new NotImplementedException();

    public (Ax, double)[] TranslateActualCoors(Place place, (Ax axis, double pos)[] position) => throw new NotImplementedException();

    public double TranslateSpecCoor(Place place, double position, Ax axis) => throw new NotImplementedException();

    public void ConfigureGeometry(Dictionary<Place, (Ax, double)[]> places) => throw new NotImplementedException();

    public void ConfigureGeometry(Dictionary<Place, double> places) => throw new NotImplementedException();

    public IGeometryBuilder<Place> ConfigureGeometryFor(Place place) => throw new NotImplementedException();
}

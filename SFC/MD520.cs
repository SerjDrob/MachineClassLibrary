...
//            {
//                int current;
//                data = await _client.ReadHoldingRegistersAsync(1, 0x3000, 1).ConfigureAwait(false);
//                _onFreq = data[0] == 0x0001 | data[0] == 0x0002;
//                stop = data[0] == 0x0003;

//                data = await _client.ReadHoldingRegistersAsync(1, 0x1004, 1).ConfigureAwait(false);
//                current = data[0];

//                data = await _client.ReadHoldingRegistersAsync(1, 0x1001, 1).ConfigureAwait(false);
//                _freq = data[0];

//                data = await _client.ReadHoldingRegistersAsync(1, 0x7044, 2).ConfigureAwait(false);
